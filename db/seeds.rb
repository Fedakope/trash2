...
# User.create!([
#   {email: "nil@gmail.com", encrypted_password: "$2a$11$uCpLiPqBiz5DcbgvCkigl.Jp6xjm5MDlvtA9Af1RSYa2RmMkWrGC.", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: nil, firstname: "Nil", picture: "nil.jpg"},
#   {email: "camille@gmail.com", encrypted_password: "$2a$11$bWWy1Zh82g4qhn/pyDLUVuKLtbw84/H0J4A46IVT4r/NmYbdpbEce", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: nil, firstname: "Camille", picture: "camille.jpg"},
#   {email: "laurine@gmail.com", encrypted_password: "$2a$11$kpyTQOW6ocBVavmmPgBTpeEYgLn3nyWsa1kajMWw01DjCaNkNvfV.", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: nil, firstname: "Laurine", picture: "laurine.jpg"},
#   {email: "gautier@gmail.com", encrypted_password: "$2a$11$1mLYl2KqNUI1lvfsKoRbpefPscGCHFTxRu5ad3f1VIvDG2qmNOx2e", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: nil, firstname: "Gautier", picture: "gautier.jpg"},
#   {email: "helene@gmail.com", encrypted_password: "$2a$11$H/FkOBF/8hsqs1LcSocBmuqeS1gf7.vbhxNbesPw0zw2YKY7CjdKq", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: nil, firstname: "Helene", picture: "helene.jpg"},
#   {email: "julie@gmail.com", encrypted_password: "$2a$11$ev4Ic9MebQXbOfJ6Zecn4.ESw5vfMwjqs3N.DVkbxp0HeKHi1imni", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: nil, firstname: "Julie", picture: "julie.jpg"},
#   {email: "loic@gmail.com", encrypted_password: "$2a$11$XmFLmTSu7MjKzMdX2cIt8OdSCg/bNM.PF6nbjfhyQ8APNkaH3E9pG", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: nil, firstname: "Loïc", picture: "loic.jpg"},
#   {email: "christophe@gmail.com", encrypted_password: "$2a$11$lybQTbT8JywHaJqVJqyuk./bwO89cSY9saHClN9qjXrJKiX3AN9zG", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: nil, firstname: "Christophe", picture: "christophe.jpg"}
# ])
# Character.create!([
...
# ])
# Post.create!([
#   {title: "Jon découvre son identité par Sam", user_id: 14, episode: "1", character_id: 32, status: "Gagné", point: 2},
#   {title: "Jon découvre son identité par Sam", user_id: 11, episode: "1", character_id: 32, status: "Gagné", point: 2},
#   {title: "Un personnage principal meurt", user_id: 9, episode: "1", character_id: 36, status: "Perdu", point: 0},
#   {title: "Les dragons auront une armure en verre-dragon", user_id: 9, episode: "5", character_id: 46, status: "En cours...", point: 0},
#   {title: "Ouverture de l'épisode sur Winterfell", user_id: 10, episode: "1", character_id: 32, status: "Gagné", point: 1},
#   {title: "Retrouvailles des Stark", user_id: 10, episode: "1", character_id: 33, status: "Gagné", point: 1},
#   {title: "Jon va monter Rhaegal au cours de l'épisode", user_id: 14, episode: "1", character_id: 32, status: "Gagné", point: 2},
#   {title: "Jon va monter Rhaegal au cours de l'épisode", user_id: 12, episode: "1", character_id: 32, status: "Gagné", point: 2},
#   {title: "Euron ramène la Cie Dorée à Cersei à King's Landing", user_id: 14, episode: "1", character_id: 48, status: "Gagné", point: 2},
#   {title: "Jon et Daenerys recouchent ensemble", user_id: 14, episode: "3", character_id: 44, status: "En cours...", point: 0},
#   {title: "Cersei n'est pas enceinte", user_id: 11, episode: "5", character_id: 29, status: "En cours...", point: 0},
#   {title: "Gendry fabrique l'armure des dragons", user_id: 11, episode: "5", character_id: 50, status: "En cours...", point: 0},
#   {title: "Bran va révèler à Jon Snow que c'est Jaime qui l'a poussé", user_id: 10, episode: "2", character_id: 34, status: "En cours...", point: 0},
#   {title: "Jon va révéler à Daenerys qu'il est le fils Targaryen", user_id: 10, episode: "5", character_id: 32, status: "Gagné", point: 2},
#   {title: "Bronn ne va tuer ni Jaime ni Tyrion", user_id: 10, episode: "5", character_id: 38, status: "En cours...", point: 0},
#   {title: "Bronn ne va tuer ni Jaime ni Tyrion", user_id: 9, episode: "5", character_id: 38, status: "En cours...", point: 0},
#   {title: "Rhaegal va se faire tuer", user_id: 9, episode: "6", character_id: 47, status: "En cours...", point: 0},
#   {title: "Nymeria va sauver Arya dans la bataille contre les marcheurs blancs", user_id: 10, episode: "3", character_id: 52, status: "En cours...", point: 0},
#   {title: "Jaime va dire toute la verité sur le Roi Fou à Daenerys", user_id: 10, episode: "2", character_id: 30, status: "En cours...", point: 0},
#   {title: "Ghost revient auprès de Jon Snow", user_id: 10, episode: "2", character_id: 51, status: "Gagné", point: 2},
#   {title: "Brienne tue un lieutenant Marcheur Blanc", user_id: 10, episode: "3", character_id: 36, status: "En cours...", point: 0},
#   {title: "Le Limier tue son frère mort-vivant avec sa hache en verre-dragon", user_id: 9, episode: "6", character_id: 40, status: "En cours...", point: 0},
#   {title: "Le générique change à mesure que les marcheurs blancs avancent sur Westeros", user_id: 9, episode: "2", character_id: 31, status: "Gagné", point: 2},
#   {title: "Test DB:SEED:DUMP", user_id: 12, episode: "3", character_id: 32, status: "En cours", point: 0}
# ])
# User.create!([
